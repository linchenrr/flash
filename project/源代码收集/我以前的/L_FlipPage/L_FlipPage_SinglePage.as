package L_FlipPage
{
	...
	*/
	public class L_FlipPage_SinglePage extends Sprite 
	{
		...
		//指示是否以映像模式显示
		private var _cacheAsPhoto:Boolean;
		//是否对图像进行平滑处理
		...
		public function L_FlipPage_SinglePage(c_a_p:Boolean = true, smo:Boolean = true, p_name:String = null):void
		{
			init(c_a_p, smo, p_name);
		}
		function init(c_a_p:Boolean, smo:Boolean,p_name:String):void
		{
			_page = new Sprite();
		...
		public function take_a_Photo(smo:Boolean = true):void
		{
			_smoothing = smo;
			cacheAsPhoto = true;
		}
		...
		public function refresh_page():void
		{
			...
			{				
				...
				_page_bitmap.smoothing = _smoothing;
