	...
	*/
	public class L_FlipPage_BtnManager extends Sprite 
	{
		...
		function init():void
		{
			...
			btn_5 = new L_FlipPage_btn(5, w, h);
			btn_6 = new L_FlipPage_btn(6, w, h);
			btn_7 = new L_FlipPage_btn(7, w, h);
			btn_8 = new L_FlipPage_btn(8, w, h);
		...
		{			
			...
			var dis_h:Number = values.page_height / 5;
