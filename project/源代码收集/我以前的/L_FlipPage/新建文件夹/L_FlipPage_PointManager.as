package L_FlipPage
{
	...
	*/
	public class L_FlipPage_PointManager extends EventDispatcher
	{
		...
		private var ax:int, ay:int, bx:int, by:int, cx:int, cy:int, dx:int, dy:int, vx:int, vy:int, gx:int, gy:int, hx:int, hy:int, ex:int, ey:int, fx:int, fy:int;
		//卷起页的角度
		private var _vk:Number;
